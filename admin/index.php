    ...
    <body class="animsition">
        <div class="page-wrapper">
            ...
            <div class="page-container">
                ...
                <!-- MAIN CONTENT-->
                <div class="main-content" style="background-color: #F0FFFF;">
                    <div class="section__content section__content--p30" style="background-color: #F0FFFF;">
                        <DIV class="container-fluid" style="background-color: #F0FFFF;">
                            <?php
                            $db->showInTable("user", "*", array(), "all", $externallinks = "", array(), $sort);
                            ?>
                        </DIV>
                    </div>
                </div>
